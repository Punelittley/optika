  ...
  const salonsData = [
    {
      ...
      desc: "Главный офис оптики и собственная мастерская. Диагностика зрения оптометристами, приём детского и взрослого офтальмолога, срочное изготовление очков. Ремонт очков любой сложности (пайка шарниров, замена носовых упоров, установка болтиков). Большой выбор оправ и солнцезащитных очков, очковые линзы всех известных мировых производителей (Essilor, Shamir, Carl Zeiss, BBGR, Neolook, Завод ОДВ).",
      hours: "10:00 – 19:00",
    ...
    },
    {
      ...
      badge: "Салон оптики",
      desc: "Диагностика зрения оптометристами, приём детского и взрослого офтальмолога, срочное изготовление очков. Ремонт очков любой сложности (пайка шарниров, замена носовых упоров, установка болтиков). Большой выбор оправ и солнцезащитных очков, очковые линзы всех известных мировых производителей (Essilor, Shamir, Carl Zeiss, BBGR, Neolook, Завод ОДВ).",
      hours: "10:00 – 19:00",
      link: "https://vk.me/uraloptikm"
    },
    {
